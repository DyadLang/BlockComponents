...
"""
   Triangular(; name, start_time, offset, amplitude, frequency)
...
"""
@component function Triangular(; name, start_time=0, offset=0, amplitude=nothing, frequency=nothing)
  ...
  append!(__params, @parameters (period::Float64 = 1 / frequency))
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, y ~ ifelse(start_time < t, 4 * amplitude * frequency * abs(abs(mod(t - period / 4 - start_time, period)) - period / 2) - amplitude, offset))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Triangular)) = print(io,
