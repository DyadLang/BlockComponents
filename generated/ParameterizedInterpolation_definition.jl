...
# Component ParameterizedInterpolation is an external component definition.  This means that the
# code for this component should be written in native Julia and will not be generated by
# the dyad compiler

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(ParameterizedInterpolation)) = print(io,
