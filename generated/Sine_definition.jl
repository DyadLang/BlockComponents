...
"""
   Sine(; name, start_time, offset, amplitude, frequency, phase)
...
"""
@component function Sine(; name, start_time=0, offset=0, amplitude=nothing, frequency=nothing, phase=0)
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, y ~ ifelse(start_time < t, offset + amplitude * sin(2 * π * frequency * (t - start_time) + phase), offset))
