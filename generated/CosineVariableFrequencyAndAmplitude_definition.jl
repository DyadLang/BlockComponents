...
"""
@component function CosineVariableFrequencyAndAmplitude(; name, phi0=0, offset=0)

  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (phi0::Float64 = phi0), [description = "Initial phase of the cosine wave"])
  append!(__params, @parameters (offset::Float64 = offset), [description = "Offset of the cosine wave"])
  ...
  append!(__vars, @variables (phi(t)), [description = "Phase of the cosine wave"])
  ...
  push!(__eqs, y ~ offset + amplitude * cos(phi))

  # Return completely constructed ODESystem
  return ODESystem(__eqs, t, __vars, __params; systems=__systems, defaults=__defaults, name, initialization_eqs=__initialization_eqs)
end
export CosineVariableFrequencyAndAmplitude

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(CosineVariableFrequencyAndAmplitude)) = print(io,
