...
@component function Plant(; name)
  ...
  append!(__vars, @variables (x1(t)))
  append!(__vars, @variables (x2(t)))
  ...
  __eqs = Equation[]
  push!(__eqs, D(x1) ~ x2)
  push!(__eqs, D(x2) ~ -x1 - 0.5 * x2 + u)
  push!(__eqs, y ~ 0.5 * x1 + x2)
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Plant)) = print(io,
