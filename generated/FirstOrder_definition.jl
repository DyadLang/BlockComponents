...
"""
@component function FirstOrder(; name, T=nothing, k=1)
  ...
  append!(__vars, @variables (x(t)), [description = "State of FirstOrder filter"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(FirstOrder)) = print(io,
