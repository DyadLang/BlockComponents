...
"""
@component function ReverseCausality(; name)
...
export ReverseCausality

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(ReverseCausality)) = print(io,
