...
"""
   ContinuousClock(; name, start_time, offset)
...
"""
@component function ContinuousClock(; name, start_time=0, offset=0)
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, y ~ ifelse(start_time < t, offset + t - start_time, offset))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(ContinuousClock)) = print(io,
