...
"""
   Cosine(; name, start_time, offset, amplitude, frequency, phase)
...
"""
@component function Cosine(; name, start_time=0, offset=0, amplitude=nothing, frequency=nothing, phase=0)
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, y ~ ifelse(start_time < t, offset + amplitude * cos(2 * π * frequency * (t - start_time) + phase), offset))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Cosine)) = print(io,
