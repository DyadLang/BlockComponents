...
@component function Integrator(; name, x0=0, k=1)
  ...
  ### Symbolic Parameters
  __params = Any[]
  append!(__params, @parameters (x0::Float64 = x0), [description = "Initial value of the integrator state"])
  ...
  append!(__vars, @variables (x(t)), [description = "State of Integrator"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Integrator)) = print(io,
