...
"""
   Step(; name, start_time, offset, height)
...
"""
@component function Step(; name, start_time=0, offset=0, height=nothing)
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, y ~ ifelse(t >= start_time, height + offset, offset))
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(Step)) = print(io,
